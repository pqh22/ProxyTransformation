...
class EmbodiedScanDataset(BaseDataset):
    ...
    def share_serialize_data(self):
        ...
        if cur_rank == 0:
            ...
            if os.path.exists(f"/dev/shm/embodiedscan_data_bytes"):
                ...
                sa_create(f"shm://embodiedscan_data_bytes", self.data_bytes)
                sa_create(f"shm://embodiedscan_data_address", self.data_address)
    ...
    def parse_ann_info(self, info: dict, task='det') -> dict:
