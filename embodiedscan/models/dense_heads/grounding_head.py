...
class GroundingHead(BaseModule):
    ...
    def loss(self, hidden_states: Tensor, all_layers_pred_bboxes: Tensor,
        ...
        for data_sample in batch_data_samples:
            batch_input_metas.append(data_sample.metainfo) # dict_keys(['img_shape', 'depth2img', 'pcd_scale_factor', 'sample_idx', 'scan_id', 'pcd_trans', 'pcd_rotation_angle', 'ori_shape', 'tokens_positive', 'pad_shape', 'cam2img', 'scale_factor', 'transformation_3d_flow', 'batch_input_shape', 'pcd_rotation', 'img_path', 'axis_align_matrix', 'text'])
            batch_gt_instances_3d.append(data_sample.gt_instances_3d) # ['text_token_mask', 'positive_maps', 'labels_3d', 'bboxes_3d']
        # data_sample.gt_instances_3d.bboxes_3d.shape (1,9)
        outs = self(hidden_states, text_feats, text_token_mask)
