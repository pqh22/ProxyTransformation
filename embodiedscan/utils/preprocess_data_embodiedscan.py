...
dataset_config=dict(type=dataset_type,
            ...
            vg_file='embodiedscan_test_vg_for_preprocessing.json',
            metainfo=metainfo,
...
save_path = '/cluster/nvme6/zjh/preprocessed_data_200frames_mv_test'
import time
start = time.time()
...
scans2process = mmengine.load('/cluster/home2/zjh/EmbodiedScan/data/embodiedscan_test_vg_for_preprocessing.json')
...
for idx in mmengine.track_iter_progress(indices):
    data = dataset[idx]
